var camera, scene, renderer, width, height, clock, orbitControl, fpsStats, dae, model_mesh;
var objects = [];
...
function init() {
	...
	scene.setGravity(new THREE.Vector3( 0, 12.5, 25));
	...
	var pointLight_1 = new THREE.PointLight(0xffffff, 0.75);
	pointLight_1.position.set(-500, -100, 0);

	var pointLight_2 = new THREE.PointLight(0xffffff, 0.75);
	pointLight_2.position.set(500, -100, 0);
